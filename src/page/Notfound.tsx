  ...
  return (
    <div>
      <div className="bg-gray-100 h-screen justify-center">
        <center className="m-auto h-screen py-28">
          <svg
            className="emoji-404 "
          ...
          <div className="tracking-widest mt-4 mb-8">
            <span className="text-gray-500 text-6xl block tracking-widest mb-[15px] font-[500]">
              <span>404</span>
            </span>
            <span className="text-gray-500 text-xl font-[400]">
              Sorry, We couldn't find what you are looking for!
            </span>
          </div>
          <a
            href="/"
            className="text-gray-500 font-[500] font-mono text-xl bg-gray-200 py-3 px-5 rounded-md hover:shadow-md duration-300"
          >
            Go back
          </a>
        </center>
